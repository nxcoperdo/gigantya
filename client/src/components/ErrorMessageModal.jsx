...
export default function ErrorMessageModal({ isOpen, onClose, message }) {
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm animate-fadeIn">
      <div className="bg-[color:var(--bg-elevated)] rounded-2xl max-w-md w-full shadow-2xl overflow-hidden animate-scaleUp">
        <div className="p-6 text-center">
          ...
          <h3 className="text-xl font-bold text-[color:var(--text-primary)] mb-2">Hubo un problema</h3>
